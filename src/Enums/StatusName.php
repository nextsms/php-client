...
enum StatusName
{
    ...
    {
        return match ($name) {
            'REJECTED_NETWORK' => self::REJECTED_NETWORK,
            'REJECTED_PREFIX_MISSING' => self::REJECTED_PREFIX_MISSING,
            'REJECTED_DND' => self::REJECTED_DND,
            'REJECTED_SOURCE' => self::REJECTED_SOURCE,
            'REJECTED_NOT_ENOUGH_CREDITS' => self::REJECTED_NOT_ENOUGH_CREDITS,
            'REJECTED_SENDER' => self::REJECTED_SENDER,
            'REJECTED_DESTINATION' => self::REJECTED_DESTINATION,
            'REJECTED_PREPAID_PACKAGE_EXPIRED' => self::REJECTED_PREPAID_PACKAGE_EXPIRED,
            'REJECTED_DESTINATION_NOT_REGISTERED' => self::REJECTED_DESTINATION_NOT_REGISTERED,
            'REJECTED_ROUTE_NOT_AVAILABLE' => self::REJECTED_ROUTE_NOT_AVAILABLE,
            'REJECTED_FLOODING_FILTER' => self::REJECTED_FLOODING_FILTER,
            'REJECTED_SYSTEM_ERROR' => self::REJECTED_SYSTEM_ERROR,
            'REJECTED_DUPLICATE_MESSAGE_ID' => self::REJECTED_DUPLICATE_MESSAGE_ID,
            'REJECTED_INVALID_UDH' => self::REJECTED_INVALID_UDH,
            'REJECTED_MESSAGE_TOO_LONG' => self::REJECTED_MESSAGE_TOO_LONG,
            'MISSING_TO' => self::MISSING_TO,
            'REJECTED_INVALID_DESTINATION' => self::REJECTED_INVALID_DESTINATION,
            default => throw new \InvalidArgumentException('Invalid Status Name'),
        };
    }
